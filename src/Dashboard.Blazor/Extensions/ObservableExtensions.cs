...
public static class ObservableExtensions
{
    ...
    {
        // This sample shows adapting an observable to a ChannelReader without backpressure,
        // if the connection is slower than the producer, the memory will start to increase.

        // If the channel is bounded, TryWrite will return false and effectively drop items.
